...
cat $WORK/SAEVA_outputs/changes/7high3lows/1/combined.txt |grep -w $result |cut --complement -f6,9,10 | sed 's/AB=.*;ANN=/ANN=/' |uniq > $WORK/SAEVA_outputs/changes/7high3lows/1/results.txt
...
cat $WORK/SAEVA_outputs/changes/7high3lows/2/combined.txt |grep -w $result |cut --complement -f6,9,10 | sed 's/AB=.*;ANN=/ANN=/' |uniq > $WORK/SAEVA_outputs/changes/7high3lows/2/results.txt
...
cat $WORK/SAEVA_outputs/changes/7high3lows/3/combined.txt |grep -w $result |cut --complement -f6,9,10 | sed 's/AB=.*;ANN=/ANN=/' |uniq > $WORK/SAEVA_outputs/changes/7high3lows/3/results.txt
...
cat $WORK/SAEVA_outputs/changes/7high3lows/4/combined.txt |grep -w $result |cut --complement -f6,9,10 | sed 's/AB=.*;ANN=/ANN=/' |uniq > $WORK/SAEVA_outputs/changes/7high3lows/4/results.txt
...
cat $WORK/SAEVA_outputs/changes/6highs4lows/1/combined.txt |grep -w $result |cut --complement -f6,9,10 | sed 's/AB=.*;ANN=/ANN=/' |uniq > $WORK/SAEVA_outputs/changes/6highs4lows/1/results.txt
...
cat $WORK/SAEVA_outputs/changes/6highs4lows/2/combined.txt |grep -w $result |cut --complement -f6,9,10 | sed 's/AB=.*;ANN=/ANN=/' |uniq > $WORK/SAEVA_outputs/changes/6highs4lows/2/results.txt
...
cat $WORK/SAEVA_outputs/changes/6highs4lows/3/combined.txt |grep -w $result |cut --complement -f6,9,10 | sed 's/AB=.*;ANN=/ANN=/' |uniq > $WORK/SAEVA_outputs/changes/6highs4lows/3/results.txt
